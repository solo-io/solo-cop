...
kubectl get RateLimitPolicy rate-limit-policy -n web-team --context $MGMT || fail-message "Could not find the rate-limit-policy RateLimitPolicy in the web-team namespace in the mgmt cluster"
