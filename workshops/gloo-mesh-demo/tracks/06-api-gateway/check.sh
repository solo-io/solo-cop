...
kubectl get RateLimitPolicy frontend -n web-team --context $MGMT || fail-message "Could not find the frontend RateLimitPolicy in the web-team namespace in the mgmt cluster"
