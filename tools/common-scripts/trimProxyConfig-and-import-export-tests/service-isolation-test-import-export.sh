...
echo "Modifying podinfo-frontend WorkspaceSettings to export to and import from podinfo-backend Workspace"
...
echo "Modifying podinfo-backend WorkspaceSettings to export to and import from podinfo-frontend Workspace"
kubectl apply --context ${MGMT} -f - <<EOF
apiVersion: admin.gloo.solo.io/v2
kind: WorkspaceSettings
metadata:
